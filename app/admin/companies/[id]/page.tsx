...
export default function CompanyDetailPage() {
  ...
  const handleCreateCompanyAdmin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Reload users to show the new Company Admin
        ...
        <div className="border-t border-gray-200">
          <div className="mt-8">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium">Company Admins ({companyAdmins.length})</h3>
              <button
            ...
            {companyAdmins.length === 0 ? (
              <p className="text-gray-500">No company admins</p>
            ) : (
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                ...
                <div className="bg-yellow-50 border border-yellow-300 rounded p-4 mb-4">
                  ...
                  <p className="text-sm text-yellow-700 mb-3">
                    This temporary password will only be shown ONCE. Please save it securely and provide it to the Company Admin.
                  </p>
                ...
                <p className="text-sm text-gray-700 mb-4">
                  The Company Admin can now log in using their <strong>email</strong> and this temporary password.
                </p>
                <button
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      The Company Admin will use this email to log in.
                    </p>
                  </div>
